...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == 'delete') {
        ...
        $delete_sql = "DELETE FROM rezervari_citybreak WHERE id='$id'";
...
$sql = "SELECT * FROM rezervari_citybreak";
          ...
          <div class="col-xl-12">
             <div class="card">
                <div class="card-body" style="padding-left:80px;">
                   <h4 class="box-title">Rezervări Citybreak</h4>
                </div>
                <div class="card-body--">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($res)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($row['hotel_ales']) ?></td>
                                        <td><?php echo htmlspecialchars($row['data_plecare']) ?></td>
                                        <td><?php echo htmlspecialchars($row['data_retur']) ?></td>
