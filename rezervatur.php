...
*{
 ...
 #video-background {
    ...
    right: 0;
    bottom: 0;
    min-width: 100%; /* Corectare: min-width în loc de min-widths */
    min-height: 100%;
    width: auto;
    height: auto;
    z-index: -1000;
...
@media screen and (max-width: 970px) {
      #cityTitle {
        font-size: 1.5em; /* Mărim font-size-ul pentru vizibilitate */
        padding: 10px; /* Adăugăm padding pentru spațiu în jurul textului */
        text-align: center; /* Centrăm textul pe ecranele mici */
        color: #000; /* Schimbăm culoarea textului pentru a fi mai vizibil */
        margin-top: 10px; /* Spațiu suplimentar deasupra titlului */
    }
    form {
        margin-top: 50px; /* Reducem spațiul de sus pentru a face loc pentru bara de navigație */
        margin-left: 0; /* Eliminăm margin-left pentru a centra formularul */
        width: 100%; /* Formularul va avea acum lățimea totală a ecranului */
        padding: 0 20px; /* Adăugăm puțin spațiu la margini pentru o estetică mai bună */

        /* Ajustăm elementele în coloană pentru a le face responsive */
        align-items: stretch; /* Elementele vor ocupa toată lățimea disponibilă */
    }

    .form-section {
        width: 100%; /* Formularul va avea lățimea totală a containerului său */
        margin-bottom: 20px; /* Spațiu între secțiuni */
    }

    .section-header {
        text-align: center; /* Centrăm textul titlului */
        margin-bottom: 10px; /* Spațiu între titlu și restul secțiunii */
    }

    .section-body {
        flex-direction: column; /* Elementele vor fi aliniate pe coloană */
    }

    .section-body input,
    .section-body textarea,
    .section-body select {
        width: 100%; /* Elementele de input vor ocupa lățimea totală */
    }

    textarea {
        height: 150px; /* Ajustăm înălțimea textarea pentru o experiență mai bună de utilizare */
    }

    .reservation-row {
        width: 100%; /* Setăm lățimea completă pentru această secțiune */
    }

    .form-footer {
        width: 100%; /* Setăm lățimea completă pentru footer-ul formularului */
        text-align: center; /* Aliniem butonul la centru */
    }

    .form-footer button {
        margin-top: 20px; /* Spațiu între buton și alte elemente */
    }
}
#message-container {
    position: fixed;
...
<video id="video-background" autoplay muted loop>
    ...
    <form id="reservationForm" action="submit_tur.php" method="post">
     <?php
    // Includeți fișierul de conexiune la baza de date
    include_once 'connection.php';
        ...
        if ($result->num_rows > 0) {
            // Display city details
             while($row = $result->fetch_assoc()) {
                echo "<h1 id='cityTitle'>Tur " . $row["nume_oras"] . "</h1>";
    ...
    ?>
        ...
        <div class="form-section">
            ...
            <div class="reservation-row">
                ...
                <input type="date" name="data_tur" required>
            </div>
