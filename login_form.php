...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      $error[] = 'e-mail sau parolă incorectă.';
   }
...
<div class="form-container">
    ...
    <input type="hidden" name="redirect" value="<?php echo htmlspecialchars($redirect_url); ?>">
        <input type="email" name="usermail" placeholder="e-mail" class="box" required>
        <input type="password" name="password" placeholder="parola" class="box" required>
        <input type="submit" value="conectează-te" class="form-btn" name="submit">
        <p>Nu ai un cont?<a href="register_form.php">Înregistrează-te acum!</a></p>
    </form>
</div>
  <!-- Footer -->
  <footer>
