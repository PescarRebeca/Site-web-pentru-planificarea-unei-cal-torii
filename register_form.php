...
<div class="form-container">
   ...
   <form action="" method="post">
      <h3 class="title">Înregistează-te acum!</h3>
      <?php
         if(isset($error)){
      ...
      ?>
      <input type="email" name="usermail" placeholder="introdu e-mail " class="box" required>
      <input type="password" name="password" placeholder="setează o parolă" class="box" required>
      <input type="password" name="cpassword" placeholder="confirmă parola" class="box" required>
      <input type="submit" value="înregistează-te" class="form-btn" name="submit">
      <p>Ai deja un cont? <a href="login_form.php">Conectează-te acum!</a></p>
   </form>
